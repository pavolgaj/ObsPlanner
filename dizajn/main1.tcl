...
#  Oct 16, 2019 08:51:41 PM CEST  platform: Windows NT
set vTcl(timestamp) ""
...
set vTcl(active_menu_fg) #000000
    ...
    .pop38 add cascade \
        -menu .pop38.men47 -activebackground $vTcl(analog_color_m) \
    ...
    .pop38.men47 add command \
        ...
        -background $vTcl(actual_gui_bg) -command NewFile -font {} \
        -foreground $vTcl(pr,menufgcolor) -label New 
    .pop38.men47 add command \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        -background $vTcl(actual_gui_bg) -command OpenFile -font {} \
        -foreground $vTcl(pr,menufgcolor) -label Open 
    .pop38.men47 add command \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        -background $vTcl(actual_gui_bg) -command SaveFile -font {} \
        -foreground $vTcl(pr,menufgcolor) -label Save 
    .pop38.men47 add separator \
        -background $vTcl(actual_gui_bg) 
    .pop38.men47 add command \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        -background $vTcl(actual_gui_bg) -command Exit -font {} \
        -foreground $vTcl(pr,menufgcolor) -label Exit 
    .pop38 add cascade \
        -menu .pop38.men49 -activebackground $vTcl(analog_color_m) \
        -activeforeground #000000 -background $vTcl(actual_gui_bg) \
        -command {{}} -font {} -foreground $vTcl(pr,menufgcolor) \
        -label Import/Export -state disabled 
    set site_2_0 "."
    menu .pop38.men49 \
        -activebackground #f9f9f9 -activeforeground black \
        -background $vTcl(pr,menubgcolor) -font {-family {Segoe UI} -size 9} \
    ...
    .pop38 add command \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        -background $vTcl(actual_gui_bg) -command Settings -font {} \
        -foreground $vTcl(pr,menufgcolor) -label Settings -state normal 
    .pop38 add command \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        -background $vTcl(actual_gui_bg) -command About -font {} \
        -foreground $vTcl(pr,menufgcolor) -label About -state normal 
...
proc vTclWindow.top37 {base} {
    ...
    wm geometry $top 834x451+232+75
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    canvas $top.can42 \
        ...
        -height 191 -highlightbackground $vTcl(actual_gui_bg) \
    ...
    canvas $top.can43 \
        -background $vTcl(actual_gui_bg) -borderwidth 2 -closeenough 1.0 \
        -height 171 -highlightbackground $vTcl(actual_gui_bg) \
        -highlightcolor black -insertbackground black -relief ridge \
        -selectbackground #c4c4c4 -selectforeground black -width 271 
    ...
    button $top.but45 \
        ...
        -background $vTcl(actual_gui_bg) -command NowTime \
    ...
    text $site_3_0.tex51 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -insertbackground black -selectbackground #c4c4c4 \
        -selectforeground black -width 256 -wrap word 
    ...
    button $site_3_0.but52 \
        -activebackground $vTcl(analog_color_m) -activeforeground black \
        -background $vTcl(actual_gui_bg) -command EditObj \
        -disabledforeground #a3a3a3 -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text Edit 
    ...
    button $site_3_0.but53 \
        -activebackground $vTcl(analog_color_m) -activeforeground black \
        -background $vTcl(actual_gui_bg) -command DelObj \
        -disabledforeground #a3a3a3 -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text Delete 
    ...
    button $site_3_0.but54 \
        -activebackground $vTcl(analog_color_m) -activeforeground black \
        -background $vTcl(actual_gui_bg) -command AddObj \
        -disabledforeground #a3a3a3 -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text Add 
    ...
    label $site_3_0.lab43 \
        ...
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) -text Show 
    ...
    labelframe $top.lab43 \
        -font TkDefaultFont -foreground black -text Observations \
        -background $vTcl(actual_gui_bg) -height 435 \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -width 250 
    ...
    button $site_3_0.but46 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        -background $vTcl(actual_gui_bg) -command AddObs \
        -disabledforeground #a3a3a3 -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text Add 
    ...
    button $site_3_0.but47 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        -background $vTcl(actual_gui_bg) -command EditObs \
        -disabledforeground #a3a3a3 -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text Edit 
    ...
    button $site_3_0.but48 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        -background $vTcl(actual_gui_bg) -command DelObs \
        -disabledforeground #a3a3a3 -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text Delete 
    ...
    button $site_3_0.but49 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        -background $vTcl(actual_gui_bg) -command ShowImg \
        -disabledforeground #a3a3a3 -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -state disabled -text Image 

...
def vp_start_gui():
    ...
    global val, w, root
    root = Tk()
    main2_support.set_Tk_var()
    top = New_Toplevel (root)
    main2_support.init(root, top)
    root.mainloop()
...
def create_New_Toplevel(root, *args, **kwargs):
    ...
    main2_support.set_Tk_var()
    top = New_Toplevel (w)
    main2_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class New_Toplevel:
    def __init__(self, top=None):
        ...
        self.Button1.configure(command=main2_support.NowTime)
        self.Button1.configure(pady="0")
        self.Button1.configure(text='''Now''')

        self.TLabelframe1 = ttk.Labelframe(top)
        self.TLabelframe1.place(relx=0.01, rely=0.02, relheight=0.96
                , relwidth=0.34)
        self.TLabelframe1.configure(text='''Objects''')
        self.TLabelframe1.configure(width=280)

        self.Scrolledlistbox1 = ScrolledListBox(self.TLabelframe1)
        ...
        self.Scrolledlistbox1.configure(listvariable=main2_support.objs)
        ...
        self.Button2 = Button(self.TLabelframe1)
        self.Button2.place(relx=0.36, rely=0.95, height=24, width=47, y=-13, h=6)

        self.Button2.configure(activebackground="#d9d9d9")
        self.Button2.configure(command=main2_support.EditObj)
        ...
        self.TCombobox1.place(relx=0.36, rely=0.05, relheight=0.05, relwidth=0.58
                , y=-13, h=6)
        self.TCombobox1.configure(textvariable=main2_support.combobox)
        ...
        self.Button4.configure(command=main2_support.AddObs)
        ...
        self.Button5.configure(command=main2_support.EditObs)
        ...
        self.Button6.configure(command=main2_support.DelObs)
        ...
        self.Button7.configure(command=main2_support.ShowImg)
    ...
    def popup1(event, *args, **kwargs):
        ...
        file.add_command(
                ...
                activeforeground="#000000",
                background="#d9d9d9",
                command=main2_support.OpenFile,
                font="TkMenuFont",
                foreground="#000000",
                label="Open")
        file.add_command(
                ...
                activeforeground="#000000",
                background="#d9d9d9",
                command=main2_support.SaveFile,
                font="TkMenuFont",
                foreground="#000000",
                label="Save")
        file.add_separator(
        ...
        Popupmenu1.add_command(
                ...
                activeforeground="#000000",
                background="#d9d9d9",
                command=main2_support.Settings,
                font="TkMenuFont",
                foreground="#000000",
                label="Settings")
        Popupmenu1.add_command(

...
#
    ...
    .pop38 add cascade \
        ...
        -font TkMenuFont -foreground {#000000} -label File -state normal 
    set site_2_0 "."
    menu .pop38.men47 \
        -activebackground {#f9f9f9} -activeforeground black \
    ...
    .pop38 add command \
        ...
        -foreground {#000000} -label Settings -state normal 
    .pop38 add command \
        -activebackground {#d9d9d9} -activeforeground {#000000} \
        -background {#d9d9d9} -command About -font TkMenuFont \
        -foreground {#000000} -label About -state normal 

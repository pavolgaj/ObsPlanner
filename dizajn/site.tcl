...
proc vTclWindow.top37 {base} {
    ...
    wm geometry $top 335x317+403+194
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    label $top.lab38 \
        -background {#d9d9d9} -foreground {#000000} -text Name 
    ...
    label $top.lab40 \
        -background {#d9d9d9} -foreground {#000000} -text Latitude 
    ...
    label $top.lab42 \
        -background {#d9d9d9} -foreground {#000000} -text Longitude 
    vTcl:DefineAlias "$top.lab42" "Label3" vTcl:WidgetProc "Toplevel1" 1
    entry $top.ent43 \
        -background white -font TkFixedFont -foreground {#000000} \
        -insertbackground black 
    vTcl:DefineAlias "$top.ent43" "Entry3" vTcl:WidgetProc "Toplevel1" 1
    label $top.lab44 \
        -background {#d9d9d9} -foreground {#000000} -text Elevation 
    vTcl:DefineAlias "$top.lab44" "Label4" vTcl:WidgetProc "Toplevel1" 1
    entry $top.ent45 \
        -background white -font TkFixedFont -foreground {#000000} \
        -insertbackground black 
    vTcl:DefineAlias "$top.ent45" "Entry4" vTcl:WidgetProc "Toplevel1" 1
    button $top.but46 \
    ...
    place $top.lab42 \
        -in $top -x 40 -y 160 -anchor nw -bordermode ignore 
    place $top.ent43 \
        -in $top -x 140 -y 160 -anchor nw -bordermode ignore 
    place $top.lab44 \
        -in $top -x 30 -y 220 -anchor nw -bordermode ignore 
    place $top.ent45 \
        -in $top -x 120 -y 220 -anchor nw -bordermode ignore 
    place $top.but46 \
        -in $top -x 140 -y 270 -anchor nw -bordermode ignore 
